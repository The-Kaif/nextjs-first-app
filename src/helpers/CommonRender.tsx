  ...
  <table className="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
    ...
    <tbody>
      {data.map((pokemon, index) => (
        <tr
          key={index}
          className="text-center sm:text-left odd:bg-white odd:dark:bg-gray-900 even:bg-gray-50 even:dark:bg-gray-800 border-b dark:border-gray-700"
        >
          ...
          <td className="px-4 sm:px-6 py-4 flex justify-center">
          ...
          <td className="px-4 sm:px-6 py-4">{pokemon.types}</td>
        </tr>
      ))}
    </tbody>
  </table>
